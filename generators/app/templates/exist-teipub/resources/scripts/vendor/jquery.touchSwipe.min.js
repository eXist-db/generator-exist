(function (a) {
  ...
  var p = 'left'; var o = 'right'; var e = 'up'; var x = 'down'; var c = 'in'; var z = 'out'; var m = 'none'; var s = 'auto'; var l = 'swipe'; var t = 'pinch'; var A = 'tap'; var j = 'doubletap'; var b = 'longtap'; var y = 'hold'; var D = 'horizontal'; var u = 'vertical'; var i = 'all'; var r = 10; var g = 'start'; var k = 'move'; var h = 'end'; var q = 'cancel'; var a = 'ontouchstart' in window; var v = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled; var d = window.navigator.pointerEnabled || window.navigator.msPointerEnabled; var B = 'TouchSwipe'; var n = {fingers: 1, threshold: 75, cancelThreshold: null, pinchThreshold: 20, maxTimeThreshold: null, fingerReleaseThreshold: 250, longTapThreshold: 500, doubleTapThreshold: 200, swipe: null, swipeLeft: null, swipeRight: null, swipeUp: null, swipeDown: null, swipeStatus: null, pinchIn: null, pinchOut: null, pinchStatus: null, click: null, tap: null, doubleTap: null, longTap: null, hold: null, triggerOnTouchEnd: true, triggerOnTouchLeave: false, allowPageScroll: 'auto', fallbackToMouseEvents: true, excludedElements: 'label, button, input, select, textarea, a, .noSwipe', preventDefaultEvents: true}; f.fn.swipe = function (G) {
    var F = f(this); var E = F.data(B); if (E && typeof G === 'string') {
      if (E[G]) {
        return E[G].apply(this, Array.prototype.slice.call(arguments, 1));
      }
      f.error('Method ' + G + ' does not exist on jQuery.swipe');
    } else if (!E && (typeof G === 'object' || !G)) {
    ...
    var az = (a || d || !av.fallbackToMouseEvents); var J = az ? (d ? (v ? 'MSPointerDown' : 'pointerdown') : 'touchstart') : 'mousedown'; var ay = az ? (d ? (v ? 'MSPointerMove' : 'pointermove') : 'touchmove') : 'mousemove'; var U = az ? (d ? (v ? 'MSPointerUp' : 'pointerup') : 'touchend') : 'mouseup'; var S = az ? null : 'mouseleave'; var aD = (d ? (v ? 'MSPointerCancel' : 'pointercancel') : 'touchcancel'); var ag = 0; var aP = null; var ab = 0; var a1 = 0; var aZ = 0; var G = 1; var aq = 0; var aJ = 0; var M = null; var aR = f(a4); var Z = 'start'; var W = 0; var aQ = null; var T = 0; var a2 = 0; var a5 = 0; var ad = 0; var N = 0; var aW = null; var af = null; try {
      ...
      if (aB()) {
        ...
        return;
      } var be = bd.originalEvent ? bd.originalEvent : bd; var bc; var bb = a ? be.touches[0] : be; Z = g; if (a) {
        W = be.touches.length;
      } else {
        bd.preventDefault();
      ...
      var bh = be.originalEvent ? be.originalEvent : be; if (Z === h || Z === q || am()) {
        return;
      } var bd; var bc = a ? bh.touches[0] : bh; var bf = aH(bc); a2 = at(); if (a) {
        W = bh.touches.length;
      } if (av.hold) {
        clearTimeout(af);
      }Z = k; if (W == 2) {
        ...
        aP = aL(bf.start, bf.end); al(be, aP); ag = aS(bf.start, bf.end); ab = aM(); aI(aP, ag); if (av.swipeStatus || av.pinchStatus) {
          ...
          var bb = true; if (av.triggerOnTouchLeave) {
            ...
            Z = aC(k);
          } else if (av.triggerOnTouchLeave && !bb) {
            Z = aC(h);
          } if (Z == q || Z == h) {
            O(bh, Z);
          }
      ...
      var be = bf; var bd = aA(); var bc = an(); var bb = ba(); if (!bd || bb) {
        ...
        be = h;
      } else if (!bc && bf == h && av.triggerOnTouchLeave) {
        be = q;
      } return be;
    } function O(bd, bb) {
      ...
      var bc = undefined; if (bd == l) {
        aR.trigger('swipeStatus', [bb, aP || null, ag || 0, ab || 0, W, aQ]); if (av.swipeStatus) {
          ...
          aR.trigger('swipe', [aP, ag, ab, W, aQ]); if (av.swipe) {
            ...
            case p: aR.trigger('swipeLeft', [aP, ag, ab, W, aQ]); if (av.swipeLeft) {
              bc = av.swipeLeft.call(aR, be, aP, ag, ab, W, aQ);
            } break; case o: aR.trigger('swipeRight', [aP, ag, ab, W, aQ]); if (av.swipeRight) {
              bc = av.swipeRight.call(aR, be, aP, ag, ab, W, aQ);
            } break; case e: aR.trigger('swipeUp', [aP, ag, ab, W, aQ]); if (av.swipeUp) {
              bc = av.swipeUp.call(aR, be, aP, ag, ab, W, aQ);
            } break; case x: aR.trigger('swipeDown', [aP, ag, ab, W, aQ]); if (av.swipeDown) {
        ...
        aR.trigger('pinchStatus', [bb, aJ || null, aq || 0, ab || 0, W, G, aQ]); if (av.pinchStatus) {
          ...
          switch (aJ) {
            case c: aR.trigger('pinchIn', [aJ || null, aq || 0, ab || 0, W, G, aQ]); if (av.pinchIn) {
              bc = av.pinchIn.call(aR, be, aJ || null, aq || 0, ab || 0, W, G, aQ);
            } break; case z: aR.trigger('pinchOut', [aJ || null, aq || 0, ab || 0, W, G, aQ]); if (av.pinchOut) {
      ...
      if (av.preventDefaultEvents === false) {
        ...
        var bd = av.allowPageScroll === s; switch (bc) {
          case p: if ((av.swipeLeft && bd) || (!bd && av.allowPageScroll != D)) {
            bb.preventDefault();
          } break; case o: if ((av.swipeRight && bd) || (!bd && av.allowPageScroll != D)) {
            bb.preventDefault();
          } break; case e: if ((av.swipeUp && bd) || (!bd && av.allowPageScroll != u)) {
            bb.preventDefault();
          } break; case x: if ((av.swipeDown && bd) || (!bd && av.allowPageScroll != u)) {
            bb.preventDefault();
          } break;
        }
      }
      ...
      return Boolean(av.pinchStatus || av.pinchIn || av.pinchOut);
    } function P() {
      return Boolean(a8() && aX());
    } function aV() {
      var be = aA(); var bg = an(); var bd = aO(); var bb = X(); var bc = ba(); var bf = !bc && bb && bd && bg && be; return bf;
    } function V() {
      return Boolean(av.swipe || av.swipeStatus || av.swipeLeft || av.swipeRight || av.swipeUp || av.swipeDown);
    } function I() {
      return Boolean(aV() && V());
    } function aO() {
      ...
      return Boolean(av.tap);
    } function Y() {
      return Boolean(av.doubleTap);
    } function aU() {
      return Boolean(av.longTap);
    } function Q() {
      if (N == null) {
        return false;
      ...
      return Boolean(ax() && a6());
    } function aG() {
      return Boolean(Q() && Y());
    } function ap() {
      return Boolean(a0() && aU());
    } function F() {
      ...
      return Boolean(aR.data(B + '_intouch') === true);
    } function ao(bb) {
      if (bb === true) {
